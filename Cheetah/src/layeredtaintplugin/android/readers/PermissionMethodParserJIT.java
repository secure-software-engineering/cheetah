 ...
 * Bodden, and others.
 ******************************************************************************/
package layeredtaintplugin.android.readers;
 ...
 */
public class PermissionMethodParserJIT implements ISourceSinkDefinitionProvider {
	...
	public static PermissionMethodParserJIT fromFile(String fileName) throws IOException {
		PermissionMethodParserJIT pmp = new PermissionMethodParserJIT();
		pmp.readFile(fileName);
		return pmp;
	}

	public static PermissionMethodParserJIT fromStringList(List<String> data) throws IOException {
		PermissionMethodParserJIT pmp = new PermissionMethodParserJIT(data);
		return pmp;
	}

	private PermissionMethodParserJIT() {
	}

	private PermissionMethodParserJIT(List<String> data) {
		this.data = data;
	}
